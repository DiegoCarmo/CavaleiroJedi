...
export default class Produtos extends React.Component {
	...
	async componentDidMount() {
		let resposta = await fetch('http://localhost/React/fullStackStore/src/backend/php/pegarConteudo.php?tabela=produto');
	...
	async enviarCompra(elemento) {
		...
		const url = "http://localhost/React/fullstackstore/src/backend/php/enviarCompra.php";
